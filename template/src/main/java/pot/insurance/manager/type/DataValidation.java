...
public class DataValidation {
    ...
    public enum Status {
        ...
        USER_AUTH_NOT_FOUND(Category.ABSENT, "user auth not found"),
        ...
        USER_AUTH_USERNAME_BAD_REQUIREMENTS(Category.INVALID, "user auth username does not meet the requirements"),
        USER_AUTH_PASSWORD_BAD_REQUIREMENTS(Category.INVALID, "user auth password does not meet the requirements"),
